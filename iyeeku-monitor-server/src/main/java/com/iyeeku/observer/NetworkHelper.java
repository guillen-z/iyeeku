...
public class NetworkHelper {  
      ...
      */  
            ...
            public static void main(String[] args) {  
                  if(NetworkHelper.getInstance().isReachIp("61.135.169.125")){
                      log.info("=======本机可以ping通ip："+"61.135.169.125");
                  }  
                  else{  
                      log.info("=======本机ping不通ip："+"61.135.169.125");
                  }  
                  if(NetworkHelper.getInstance().isReachNetworkInterfaces("61.135.169.125")){
                      log.info("=======本机所有网卡可以ping通ip："+"www.baidu.com");
                  }  
                  else{  
                      log.info("=======本机所有网卡ping不通ip："+"www.baidu.com");
                  }  
