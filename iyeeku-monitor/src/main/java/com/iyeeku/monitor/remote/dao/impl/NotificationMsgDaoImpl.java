...
@Repository
public class NotificationMsgDaoImpl extends BaseDaoImpl implements INotificationMsgDao{
    ...
    public Map<String, String> getNotificationMsgResultMapByZJ(String zj) {
        ...
        return this.queryOne_myBatis("com.iyeeku.monitor.remote.dao.INotificationMsgDao.getNotificationMsgResultMapByZJ" ,zj);
    }
}
